...
@Component({
  selector: 'app-alarm-ticket-pm-form',
  templateUrl: './alarm-ticket-pm-form.component.html',
  styleUrl: './alarm-ticket-pm-form.component.css'
})
...
submitForm(): void {
  const formData = this.ticketForm?.value;
      ...
      const jsonData = {
        ...
        outage: formData.outage,
        outageDateStart: formData.outageDateStart,
        outageDateEnd: formData.outageDateEnd,
        outageDuration: formData.outageDuration,
        resolutionComment: formData.resolutionComment,
        counterIndex: formData.counterIndex,
        code: formData.code,
        dcVoltage: formData.dcVoltage,
        fluentDC: formData.fluentDC,
        ...
        siteAccessRequest: formData.siteAccessRequest,
        partDescription: formData.partDescription,
        taskReference: formData.taskReference,
        workNotes: formData.workNotes,
        alarmCheckList: formData.alarmCheckList,
        popFourTab: formData.popFourTab,
        siteId: this.ticketForm!.get('site')?.value?.id,
        sheduleDate: formData.sheduleDate,
        reSheduleDate: formData.reSheduleDate,
        faultCodePrefix: formData.faultCodePrefix,
        faultCategory: formData.faultCategory,
        faultGroup: formData.faultGroup,
        fault: formData.fault,
        faultCode: formData.faultCode,
        partType: formData.partType,
        separes: formData.separes,
  ...
  if (this.ticket) {
    ...
    this.ticketService.create(jsonData)
      .subscribe(ticket => {
        console.log(ticket)
